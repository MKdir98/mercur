...
export class Migration20250203000000 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql('CREATE INDEX IF NOT EXISTS "IDX_state_postex_province_code" ON "state" (postex_province_code);');
  }
  ...
  async down(): Promise<void> {
    ...
    this.addSql('ALTER TABLE "state" DROP COLUMN IF EXISTS "postex_province_code";');
  }
}
